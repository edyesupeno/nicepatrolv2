...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200">
        <h1 class="text-xl font-semibold text-gray-900">Tambah Data Aset</h1>
        <p class="text-gray-600 mt-1">Isi form di bawah untuk menambah data aset baru</p>
    </div>
    
    <form action="{{ route('perusahaan.data-aset.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_aset" id="nama_aset" value="{{ old('nama_aset') }}" required 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal_beli" id="tanggal_beli" value="{{ old('tanggal_beli') }}" required 
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('status') border-red-500 @enderror">
                            @foreach($statusOptions as $value => $label)
                                <option value="{{ $value }}" {{ old('status', 'ada') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="pic_penanggung_jawab" id="pic_penanggung_jawab" value="{{ old('pic_penanggung_jawab') }}" required 
                ...
                <div>
                    ...
                    <textarea name="catatan_tambahan" id="catatan_tambahan" rows="4" 
                              ...
                              placeholder="Catatan atau keterangan tambahan tentang aset">{{ old('catatan_tambahan') }}</textarea>
...
// Advanced kategori search functionality

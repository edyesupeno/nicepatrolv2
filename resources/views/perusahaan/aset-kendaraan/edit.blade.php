...
@section('title', 'Edit Aset Kendaraan')
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-200">
        <h1 class="text-xl font-semibold text-gray-900">Edit Aset Kendaraan</h1>
        <p class="text-gray-600 mt-1">Edit data kendaraan: {{ $asetKendaraan->kode_kendaraan }}</p>
    </div>
    
    <form action="{{ route('perusahaan.aset-kendaraan.update', $asetKendaraan->hash_id) }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select name="project_id" id="project_id" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('project_id') border-red-500 @enderror">
                            ...
                            @foreach($projects as $project)
                                <option value="{{ $project->id }}" {{ old('project_id', $asetKendaraan->project_id) == $project->id ? 'selected' : '' }}>
                                    {{ $project->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="jenis_kendaraan" id="jenis_kendaraan" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('jenis_kendaraan') border-red-500 @enderror">
                            ...
                            @foreach($jenisOptions as $value => $label)
                                <option value="{{ $value }}" {{ old('jenis_kendaraan', $asetKendaraan->jenis_kendaraan) == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="merk" id="merk" value="{{ old('merk', $asetKendaraan->merk) }}" required 
                        ...
                        <div>
                            ...
                            <input type="text" name="model" id="model" value="{{ old('model', $asetKendaraan->model) }}" required 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="tahun_pembuatan" id="tahun_pembuatan" value="{{ old('tahun_pembuatan', $asetKendaraan->tahun_pembuatan) }}" required 
                        ...
                        <div>
                            ...
                            <input type="text" name="warna" id="warna" value="{{ old('warna', $asetKendaraan->warna) }}" required 
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nomor_polisi" id="nomor_polisi" value="{{ old('nomor_polisi', $asetKendaraan->nomor_polisi) }}" required 
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_rangka" id="nomor_rangka" value="{{ old('nomor_rangka', $asetKendaraan->nomor_rangka) }}" required 
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_mesin" id="nomor_mesin" value="{{ old('nomor_mesin', $asetKendaraan->nomor_mesin) }}" required 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="tanggal_pembelian" id="tanggal_pembelian" value="{{ old('tanggal_pembelian', $asetKendaraan->tanggal_pembelian?->format('Y-m-d')) }}" required 
                        ...
                        <div>
                            ...
                            <select name="status_kendaraan" id="status_kendaraan" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('status_kendaraan') border-red-500 @enderror">
                                @foreach($statusOptions as $value => $label)
                                    <option value="{{ $value }}" {{ old('status_kendaraan', $asetKendaraan->status_kendaraan) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga_pembelian" id="harga_pembelian" value="{{ old('harga_pembelian', $asetKendaraan->harga_pembelian) }}" required min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                <input type="number" name="nilai_penyusutan" id="nilai_penyusutan" value="{{ old('nilai_penyusutan', $asetKendaraan->nilai_penyusutan) }}" min="0" step="0.01"
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nomor_stnk" id="nomor_stnk" value="{{ old('nomor_stnk', $asetKendaraan->nomor_stnk) }}" required 
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_berlaku_stnk" id="tanggal_berlaku_stnk" value="{{ old('tanggal_berlaku_stnk', $asetKendaraan->tanggal_berlaku_stnk?->format('Y-m-d')) }}" required 
                    ...
                    <div class="bg-green-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="nomor_bpkb" id="nomor_bpkb" value="{{ old('nomor_bpkb', $asetKendaraan->nomor_bpkb) }}" required 
                            ...
                            <div>
                                ...
                                <input type="text" name="atas_nama_bpkb" id="atas_nama_bpkb" value="{{ old('atas_nama_bpkb', $asetKendaraan->atas_nama_bpkb) }}" required 
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="perusahaan_asuransi" id="perusahaan_asuransi" value="{{ old('perusahaan_asuransi', $asetKendaraan->perusahaan_asuransi) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_polis_asuransi" id="nomor_polis_asuransi" value="{{ old('nomor_polis_asuransi', $asetKendaraan->nomor_polis_asuransi) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_berlaku_asuransi" id="tanggal_berlaku_asuransi" value="{{ old('tanggal_berlaku_asuransi', $asetKendaraan->tanggal_berlaku_asuransi?->format('Y-m-d')) }}" 
                    ...
                    <div class="bg-orange-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                                    <input type="number" name="nilai_pajak_tahunan" id="nilai_pajak_tahunan" value="{{ old('nilai_pajak_tahunan', $asetKendaraan->nilai_pajak_tahunan) }}" min="0" step="0.01"
                            ...
                            <div>
                                ...
                                <input type="date" name="jatuh_tempo_pajak" id="jatuh_tempo_pajak" value="{{ old('jatuh_tempo_pajak', $asetKendaraan->jatuh_tempo_pajak?->format('Y-m-d')) }}" 
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="driver_utama" id="driver_utama" value="{{ old('driver_utama', $asetKendaraan->driver_utama) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="lokasi_parkir" id="lokasi_parkir" value="{{ old('lokasi_parkir', $asetKendaraan->lokasi_parkir) }}" 
                            ...
                            <div>
                                ...
                                <input type="number" name="kilometer_terakhir" id="kilometer_terakhir" value="{{ old('kilometer_terakhir', $asetKendaraan->kilometer_terakhir) }}" min="0"
                ...
                <div class="space-y-6">
                    <div class="bg-yellow-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="date" name="tanggal_service_terakhir" id="tanggal_service_terakhir" value="{{ old('tanggal_service_terakhir', $asetKendaraan->tanggal_service_terakhir?->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_service_berikutnya" id="tanggal_service_berikutnya" value="{{ old('tanggal_service_berikutnya', $asetKendaraan->tanggal_service_berikutnya?->format('Y-m-d')) }}" 
                    ...
                    <div>
                        ...
                        <textarea name="catatan" id="catatan" rows="4" 
                                  ...
                                  placeholder="Catatan tambahan tentang kendaraan">{{ old('catatan', $asetKendaraan->catatan) }}</textarea>
                        @error('catatan')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                            ...
                            @if($asetKendaraan->foto_kendaraan)
                                <div id="foto-current">
                                    <img src="{{ $asetKendaraan->foto_url }}" alt="Foto Kendaraan" class="max-w-full h-48 object-cover rounded-lg mx-auto mb-3">
                                    <p class="text-sm text-gray-600 mb-2">Foto saat ini</p>
                                    <button type="button" onclick="document.getElementById('foto_kendaraan').click()" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">
                                        Ganti Foto
                                    </button>
                                </div>
                            @else
                        ...
                        <div class="border-2 border-dashed border-blue-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors">
                            ...
                            @if($asetKendaraan->file_stnk)
                                <div id="stnk-current">
                                    ...
                                    <p class="text-sm text-gray-600 mb-2">File STNK tersedia</p>
                                    <div class="space-x-2">
                                        <a href="{{ $asetKendaraan->file_stnk_url }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Lihat File
                                        </a>
                                        <button type="button" onclick="document.getElementById('file_stnk').click()" class="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Ganti File
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="border-2 border-dashed border-green-300 rounded-lg p-4 text-center hover:border-green-400 transition-colors">
                            ...
                            @if($asetKendaraan->file_bpkb)
                                <div id="bpkb-current">
                                    ...
                                    <p class="text-sm text-gray-600 mb-2">File BPKB tersedia</p>
                                    <div class="space-x-2">
                                        <a href="{{ $asetKendaraan->file_bpkb_url }}" target="_blank" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Lihat File
                                        </a>
                                        <button type="button" onclick="document.getElementById('file_bpkb').click()" class="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Ganti File
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-purple-300 rounded-lg p-4 text-center hover:border-purple-400 transition-colors">
                            ...
                            @if($asetKendaraan->file_asuransi)
                                <div id="asuransi-current">
                                    <i class="fas fa-file-alt text-2xl text-purple-600 mb-2"></i>
                                    <p class="text-sm text-gray-600 mb-2">File Asuransi tersedia</p>
                                    <div class="space-x-2">
                                        <a href="{{ $asetKendaraan->file_asuransi_url }}" target="_blank" class="bg-purple-600 hover:bg-purple-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Lihat File
                                        </a>
                                        <button type="button" onclick="document.getElementById('file_asuransi').click()" class="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1 rounded text-sm transition-colors">
                                            Ganti File
                                        </button>
                                    </div>
                                </div>
        ...
        <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
            ...
            <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                <i class="fas fa-save mr-2"></i>Update Kendaraan
            </button>
        </div>
    </form>
</div>
...
function previewImage(input, previewId) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            // Hide current file display and upload placeholder
            const currentDiv = document.getElementById(previewId.replace('-preview', '-current'));
            const placeholderDiv = document.getElementById(previewId.replace('-preview', '-upload-placeholder'));
...
function removeImage(type) {
    ...
    // Hide preview and current
    document.getElementById(type + '-preview').classList.add('hidden');
    const currentDiv = document.getElementById(type + '-current');
    if (currentDiv) currentDiv.classList.add('hidden');

...
@section('page-title', 'Input Penerimaan Barang')
@section('page-subtitle', 'Catat penerimaan barang masuk')
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900">Input Penerimaan Barang</h2>
                        <p class="text-sm text-gray-600">Lengkapi data barang yang diterima</p>
                    </div>
                </div>
            </div>
        </div>

        <form action="{{ route('perusahaan.penerimaan-barang.store') }}" method="POST" enctype="multipart/form-data" id="formPenerimaanBarang">
            @csrf
            <div class="p-6 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <label class="flex items-center">
                                    <input type="radio" name="kategori_barang" value="Dokumen" class="mr-2" {{ old('kategori_barang') == 'Dokumen' ? 'checked' : '' }}>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="kategori_barang" value="Material" class="mr-2" {{ old('kategori_barang') == 'Material' ? 'checked' : '' }}>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="kategori_barang" value="Elektronik" class="mr-2" {{ old('kategori_barang') == 'Elektronik' ? 'checked' : '' }}>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="kategori_barang" value="Logistik" class="mr-2" {{ old('kategori_barang') == 'Logistik' ? 'checked' : '' }}>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="kategori_barang" value="Lainnya" class="mr-2" {{ old('kategori_barang') == 'Lainnya' ? 'checked' : '' }}>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <label class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition kondisi-option">
                                    <input type="radio" name="kondisi_barang" value="Baik" class="hidden" {{ old('kondisi_barang') == 'Baik' ? 'checked' : '' }}>
                                ...
                                <label class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition kondisi-option">
                                    <input type="radio" name="kondisi_barang" value="Rusak" class="hidden" {{ old('kondisi_barang') == 'Rusak' ? 'checked' : '' }}>
                                ...
                                <label class="flex flex-col items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition kondisi-option">
                                    <input type="radio" name="kondisi_barang" value="Segel Terbuka" class="hidden" {{ old('kondisi_barang') == 'Segel Terbuka' ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-4">
                                <label class="flex items-center px-6 py-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition pengirim-option">
                                    <input type="radio" name="pengirim" value="Kurir" class="mr-3" {{ old('pengirim') == 'Kurir' ? 'checked' : '' }}>
                                    <span class="text-sm font-medium text-gray-700">Kurir</span>
                                </label>
                                
                                <label class="flex items-center px-6 py-3 border-2 border-blue-500 bg-blue-50 rounded-lg cursor-pointer pengirim-option selected">
                                    <input type="radio" name="pengirim" value="Client" class="mr-3" {{ old('pengirim', 'Client') == 'Client' ? 'checked' : '' }}>
                                    <span class="text-sm font-medium text-blue-700">Client</span>
                                </label>
                                
                                <label class="flex items-center px-6 py-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition pengirim-option">
                                    <input type="radio" name="pengirim" value="Lainnya" class="mr-3" {{ old('pengirim') == 'Lainnya' ? 'checked' : '' }}>
                                ...
                                <div class="flex-1">
                                    ...
                                    <label for="foto_barang" class="cursor-pointer flex items-center justify-center w-full px-4 py-8 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition text-center">
                                        <div class="text-center">
                                            ...
                                            <p class="text-sm text-gray-600 font-medium" id="foto_barang_label">Pilih File</p>
                                    ...
                                    <div class="mt-4 hidden" id="foto_barang_preview">
                                        ...
                                        <p class="text-xs text-green-600 mt-2 text-center">Preview foto barang</p>
                                    </div>
                                </div>
                            </div>
                            @error('foto_barang')
                ...
                <!-- Hidden fields -->
                <input type="hidden" name="tanggal_terima" value="{{ now()->format('Y-m-d H:i:s') }}">
                <input type="hidden" name="status" value="Diterima">
                <input type="hidden" name="petugas_penerima" value="{{ auth()->user()->name }}">

                <!-- Submit Button -->
                <div class="flex justify-between items-center pt-6 border-t border-gray-200">
                    <a href="{{ route('perusahaan.penerimaan-barang.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const defaultClient = document.querySelector('input[value="Client"]');
    if (defaultClient && !document.querySelector('input[name="pengirim"]:checked')) {
        defaultClient.checked = true;
        defaultClient.parentElement.classList.add('border-blue-500', 'bg-blue-50', 'selected');
        defaultClient.parentElement.querySelector('span').classList.remove('text-gray-700');
        defaultClient.parentElement.querySelector('span').classList.add('text-blue-700');
    }
});
...
// Form validation
document.getElementById('formPenerimaanBarang').addEventListener('submit', function(e) {
...
// Initialize POS search on page load
document.addEventListener('DOMContentLoaded', function() {
    initializePosSearch();
});

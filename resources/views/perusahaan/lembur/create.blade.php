...
@section('title', 'Tambah Permintaan Lembur')
@section('page-title', 'Tambah Permintaan Lembur')
@section('page-subtitle', 'Buat permintaan lembur karyawan baru')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-medium text-gray-900">Form Permintaan Lembur</h3>
        <p class="text-sm text-gray-600">Isi form di bawah untuk membuat permintaan lembur karyawan</p>
    </div>

    <form action="{{ route('perusahaan.lembur.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                    ...
                    <div id="selected_karyawan" class="mt-2 hidden">
                        <div class="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg">
                            <div>
                                ...
                                <div class="text-sm text-blue-600" id="selected_nik"></div>
                            </div>
                ...
                @error('karyawan_id')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">Pilih project terlebih dahulu, lalu ketik minimal 2 karakter untuk mencari</p>
            </div>
        ...
        <div class="mt-6">
            ...
            <div class="relative">
                <input type="number" name="tarif_lembur_per_jam" id="tarif_lembur_per_jam" 
                       ...
                       value="{{ old('tarif_lembur_per_jam') }}" min="0" step="1000" readonly>
        ...
        <div class="mt-6">
            ...
            <textarea name="alasan_lembur" id="alasan_lembur" rows="3" 
                      ...
                      placeholder="Jelaskan alasan mengapa perlu lembur..." required>{{ old('alasan_lembur') }}</textarea>
            @error('alasan_lembur')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mt-6">
            ...
            <textarea name="deskripsi_pekerjaan" id="deskripsi_pekerjaan" rows="4" 
                      ...
                      placeholder="Jelaskan detail pekerjaan yang akan dilakukan saat lembur..." required>{{ old('deskripsi_pekerjaan') }}</textarea>
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                    ...
                    <span id="estimasi_jam" class="ml-2 font-bold text-blue-900">0 jam</span>
                </div>
                <div>
                    <span class="font-medium text-blue-800">Tarif per Jam:</span>
                    <span class="ml-2 font-bold text-blue-900">Rp <span id="estimasi_tarif">0</span></span>
                </div>
                <div>
                    <span class="font-medium text-blue-800">Total Upah:</span>
                    <span class="ml-2 font-bold text-blue-900">Rp <span id="estimasi_total">0</span></span>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('tanggal_lembur').value = new Date().toISOString().split('T')[0];

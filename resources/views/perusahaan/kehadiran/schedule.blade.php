...
@section('page-subtitle', 'Kelola jadwal kerja karyawan')

@section('content')
<div class="flex items-center justify-center min-h-[600px]">
    <div class="text-center">
        <div class="mb-8">
            <div class="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 shadow-2xl mb-6">
        ...
        <p class="text-xl text-gray-600 mb-8 max-w-md mx-auto">
            Halaman <span class="font-semibold text-purple-600">Schedule</span> sedang dalam tahap pengembangan
        </p>
        ...
        <div class="mt-12">
            <a href="{{ route('perusahaan.dashboard') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-200">
